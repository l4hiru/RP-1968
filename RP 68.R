...
colnames(W_matrix)
colnames(W_matrix)[-1] <- paste0(colnames(W_matrix)[-1], "68")
...
################# 2e SHARE FOR SS-IV AFTER VERDUGO REMARKS ########################


#RP 1968

data_1968 <- read_sas("C:/Users/srimling/Documents/Positron/RP/RP 1968/Data/verdugo_rp68_fdq_14.sas7bdat", col_select = c("IN", "N", "NC", "D", "TA", "REDI"))
